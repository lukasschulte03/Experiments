...
while 1:
    ...
    screen.blit(font.render("Hits: "+str(score),True,(255,255,255)),(5,5))
    ...
    for badguy in badguys:
        if fighter.hit_by(badguy):
            ...
            ###screen.blit(font.render(str(round(hits*(hits/shots)*100)),True, (255,255,255)),(266,348))
            ...
            if shots == 0:
                ...
                screen.blit(font.render(str("--"),True, (255,255,255)),(266,348))
            else:
                screen.blit(font.render(str(round(100*hits/shots, 3))+"%",True, (255,255,255)),(400,357))
                screen.blit(font.render(str(round(hits*(hits/shots)*100)),True, (255,255,255)),(266,348))
